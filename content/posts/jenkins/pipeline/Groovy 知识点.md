...
- **Groovy 脚本中的作用域分为绑定域和本地域。**
    - 绑定域：脚本内的全局作用域，相当于该脚本对象的成员变量。如果未定义变量，仅仅初始化但未声明，其作用域就是绑定域。
...
- 使用 [@Filed](https://docs.groovy-lang.org/2.5.8/html/gapi/index.html?groovy/transform/Field.html) 标注也可以将变量的作用域变为绑定域中。
    ```groovy
