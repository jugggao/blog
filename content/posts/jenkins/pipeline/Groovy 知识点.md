...
assert str[0..2] == "tes"
assert str[0, 2] == "ts"
assert (str << "er").toString() == "tester"
assert str.toUpperCase() == "TEST"
assert str.toLowerCase() == "test"
assert '123'.toInteger() == 123
assert '123'.toDouble() == 123.0
assert str.toList() == ['t', 'e', 's', 't']
assert str =~ /^te*/

def str2 = "Better to run than curse the road"
assert str2.split() == ['Better', 'to', 'run', 'than', 'curse', 'the', 'road']
assert str2.tokenize() == ['Better', 'to', 'run', 'than', 'curse', 'the', 'road']
```
